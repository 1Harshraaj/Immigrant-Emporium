                ...
                <Col xs={24} sm={24} md={10} lg={10} >
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <button className='button'onClick={()=>navigate('/details')}>Temple <ArrowRightAltIcon /></button>
                        </div>
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <button className='button'>Food <ArrowRightAltIcon /></button>
                        </div>
                ...
                <Col xs={24} sm={24} md={10} lg={10} >
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <button className='button'>Transport <ArrowRightAltIcon /></button>
                        </div>
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <button className='button'>Bank <ArrowRightAltIcon /></button>
                        </div>
                ...
                <Col xs={24} sm={24} md={10} lg={10} >
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <button className='button'>Shopping <ArrowRightAltIcon /></button>
                        </div>
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <button className='button'>Licence <ArrowRightAltIcon /></button>
                        </div>
                        <p style={{ width: "35%", marginLeft: 5 }}>An official paper that shows you are allowed to do or have something.</p>
                    </div>
                </Col>
            </Row>
        </div >
